class LearnController < ApplicationController
    ...
    [
      {
        ...
        technologies: ["NeoChat", "EmotiSense", "Webhooks"],
        rating: 4.9,
        students: 1247
      },
      {
        ...
        technologies: ["ContentCrafter", "APIs", "Automation"],
        rating: 4.8,
        students: 892
      },
      {
    ...
    [
      {
        ...
        technologies: ["NeoChat", "EmotiSense"],
        rating: 4.9,
        students: 1247,
        free: true
      },
  ...
  def get_related_tutorials(tutorial)
    [
      {
        id: 11,
  ...
  def get_next_tutorial(tutorial)
    {
      id: 14,
  ...
  def get_all_learning_paths
    [
      ...
      },
      {
        ...
        color: "purple",
        icon: "🏢",
        skills: ["Scalability", "Security", "Monitoring"]
      },
      {
        id: 4,
        title: "Creative AI Applications",
  ...
  def get_path_instructors(path_id)
    [
      {
  ...
  def get_path_certificate_info(path_id)
    {
      available: true,
      requirements: [
  ...
  def get_path_tutorials(path)
    ...
    curriculum.each do |module_data|
      module_data[:tutorials].each_with_index do |tutorial, index|
        tutorials << {

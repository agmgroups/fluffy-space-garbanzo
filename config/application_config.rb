...
module OneLastAI
  class Configuration
    ...
    config_accessor :rate_limit_window_ms, default: ENV['RATE_LIMIT_WINDOW_MS']&.to_i || 900000
    ...
    def self.validate_infrastructure!
      ...
      if config.cdn_url.present? && !valid_url?(config.cdn_url)
